...
function search_Icon_draw_Polygon(lat, lng, data) {
	...
	// console.log("\njdata: ", jdata);
	// console.log(jdata['coordinates'][0][0]);

	// polygon_data = jdata["coordinates"][0][0]
	// polygon_data = JSON.stringify(coordinates_data[0][0])
	...
	// 設定畫完圖後的定位位置
	// var test_list = [[120.9070194429354, 24.715836498701094], 
	lng = input_list[0][0];
	lat = input_list[0][1];
